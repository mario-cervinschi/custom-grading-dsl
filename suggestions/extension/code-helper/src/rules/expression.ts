 ...
 */
export function suggestExpressionValue(): vscode.CompletionItem[] {
 ...
 */
export function suggestComparisonRHS(): vscode.CompletionItem[] {
  const items: vscode.CompletionItem[] = [];
 ...
 */
export function suggestArithmeticRHS(): vscode.CompletionItem[] {
  const items: vscode.CompletionItem[] = [
 ...
 */
export function suggestOperatorsAfterValue(): vscode.CompletionItem[] {
  const ops = ["==", "!=", ">", "<", ">=", "<=", "&&", "||", "+", "-", "*", "/", "~", "!~", "?", "IN"];
  return ops.map((op) => {
 ...
 */
export function suggestTernaryBranch(): vscode.CompletionItem[] {
  const items: vscode.CompletionItem[] = [];
